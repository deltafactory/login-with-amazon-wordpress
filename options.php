...
function loginwithamazon_create_menu() {
    add_submenu_page( 'options-general.php', 'Login With Amazon Settings', 'Login With Amazon', 'manage_options', __FILE__, 'loginwithamazon_settings_page');
}
...
function loginwithamazon_settings_page() {
    ?>
    <div class="wrap">
        <h1>Login With Amazon Settings</h1>
